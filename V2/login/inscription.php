    ...
    <form class="needs-validation" action="action.php" method="post">
        ...
        <div class="mb-3">
          <label for="email">Email </label>
                <input name="mail" type="email" class="form-control" id="email" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[a-z]{2,}$"
        ...
        <div class="col-md-6 mb-3">
            <label for="mdp1">Mot de passe </label>
                <input name="mdp1" type="password" class="form-control" id="email" placeholder="********" minlength="5" required>
            <div class="invalid-feedback">Please enter a valid password .</div>
          </div>
          <div class="col-md-6 mb-3">
            <label for="mdp2">Confirmation de Mot de passe </label>
                <input name="mdp2" type="password" class="form-control" id="email" placeholder="********" minlength="5" required>
            <div class="invalid-feedback">Please enter a valid password .</div>
          </div>
        </div>
        ...
        <p class="mt-3 mb-3 text-muted" style="text-align: center;">
            J'ai déja un compte, je veux <strong><a href="session.php">me connecter</strong></a>
        </p>

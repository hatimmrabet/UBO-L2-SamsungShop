    ...
    <form  class="form-group mx-auto" style="width: 60%;margin:auto;" method="post" action="actualites_action.php">
        <?php
            ...
            echo('<div style="margin-bottom: 1rem;">');
                ...
                if($_SESSION['msg']==2 ) { //afficher msg danger 2
        ...
        <h5>Ajoutez une actualité : </h5>
            ...
            <label >Etat :</label>
                <select class="custom-select col" id="inputGroupSelect01" name="etat" required>
                    <option selected value="C">C</option>
                    <option value="L">L</option>
                </select>
            <input class="btn btn-lg btn-primary btn-block mt-3" type="submit" name="ajouter" value="Ajouter">
        </fieldset>
    </form>
        ...
        <?php
            ...
            echo('<div style="margin-bottom: 1rem;">');
                ...
                if($_SESSION['msg']==2 ) { //afficher msg success 2
                    echo('<div class="alert alert-danger" role="alert">');
                        echo('N° d\'actualité incorrect <br> Suppression annulé');
                    echo('</div>');
                }
            echo('</div>');
            unset($_SESSION['msg']);

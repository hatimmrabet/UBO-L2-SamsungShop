...
<body style="padding:0px;">
    ...
    <form  class="form-group mx-auto" style="width: 60%;margin:auto;" method="post" action="red_cat_action.php?edit=<?php echo $_GET['edit'] ?>">
        <?php
            ...
            echo('<div style="margin-bottom: 1rem;">');
                ...
                if($_SESSION['msg']==2){  //afficher msg error
                    echo('<div class="alert alert-danger" role="alert">');
                        echo('Vous n\'avez pas le droit de modifier cette catégorie');
                    echo('</div>');
                    }
                unset($_SESSION['msg']);
            echo('</div>');
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" style="width: 40%;" name="thedate" autofocus value="<?php echo $cat['cat_date'] ?>" required>
        </div>

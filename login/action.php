...
<body class="bg-light" style="padding-top:0px;">
    ...
    <?php
    $mysqli = new mysqli('localhost','zm_rabeha','Hatimtim123','zfl2-zm_rabeha');
    ...
    //Inscription
                ...
                if($existpseudo==0 && $existmail==0) //mail et pseudo jamais utilisés
                {
                    ...
                    {   
                        ...
                        else
                        {
                            ...
                            $problem1=0;
                            $msg=1;
                            //header("Location: login.php?pseudo=".$_POST['pseudo']);
                        }
        ...
        //affichage du message succes
        echo('<div style="margin-top:2rem;">');
            if( $msg==1 ) { //afficher msg succes
                echo('<div class="alert alert-success" role="alert">');
                    echo('Ajout de compte et de profile avec succes');
                echo('</div>');
            }
        echo('</div>');
